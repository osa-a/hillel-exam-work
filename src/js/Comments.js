...
function createCommentsData(){
    ...
    commentElem.pushToAr(commentElem);
    commentElem = new Comment('Donald', rating[3], 'The delivery was as good as could be expected. To sum it up, this is the best purchase I have made in a long time. It is like a can of sardines for guns!', 'donald.png');
    commentElem.pushToAr(commentElem);
    commentElem = new Comment('Tom', rating[4], 'This is the best purchase! It really is amazing I am taking advantage of everything you can give!', 'hardy.png');
    commentElem.pushToAr(commentElem);
